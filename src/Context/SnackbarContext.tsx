...
type Action = {type: 'show', payload: { type: string, label: string }} | {type: 'hide', payload: null}
...
const userReducer = (state: any, action: { type: any; payload: { type: string, label: string } | null; }) => {
    switch (action.type) {
        case 'show': {
